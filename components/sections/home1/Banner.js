                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="banner-content-two">
                                ...
                                <h2 className="title" data-aos="fade-up" data-aos-delay={300}>Welcome to Arthik Advisors</h2>
                                <p data-aos="fade-up" data-aos-delay={500}>We are a leading consultancy firm with a team of experienced professionals specializing in finance, accounting, management consulting, taxation, and risk control advisory.</p>
