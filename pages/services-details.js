        ...
        management: (
            <>
                <div className="services-details-content">
                    ...
                    <h4 className="title">BUSINESS DECISION-MAKING SUPPORT</h4>
                    <div className="services-details-thumb">
                        <img src="/assets/img/services/services_details01.jpg" alt="" />
                    </div>
                    ...
                    <h4 className="title">BUSINESS PROCESS IMPROVEMENT</h4>
                    <div className="services-details-thumb">
                        <img src="/assets/img/services/services_details01.jpg" alt="" />
                    </div>
        ...
        incorporation: (
            <>
                <div className="services-details-content">
                    ...
                    <h3 className="">TRUST/SOCIETY/FIRM FORMATION</h3>
                    <div className="services-details-thumb">
                        <img src="/assets/img/services/services_details01.jpg" alt="" />
                    </div>
                    ...
                    <h3 className="">GST REGISTRATION</h3>
                    <div className="services-details-thumb">
                        <img src="/assets/img/services/services_details01.jpg" alt="" />
                    </div>
                    ...
                    <h3 className="">PF/ESI REGISTRATION</h3>
                    <div className="services-details-thumb">
                        <img src="/assets/img/services/services_details01.jpg" alt="" />
                    </div>
                    ...
                    <h3 className="">UDYAM AADHAR REGISTRATION</h3>
                    <div className="services-details-thumb">
                        <img src="/assets/img/services/services_details01.jpg" alt="" />
                    </div>
                    ...
                    <h3 className="">FSSAI REGISTRATION</h3>
                    <div className="services-details-thumb">
                        <img src="/assets/img/services/services_details01.jpg" alt="" />
                    </div>
        ...
        taxation: (
            <>
                <div className="services-details-content">
                    ...
                    <h2 className="title">MONTHLY & YEARLY COMPLIANCES</h2>
                    <div className="services-details-thumb">
                        <img src="/assets/img/services/services_details01.jpg" alt="" />
                    </div>
                    ...
                    <h2 className="title">TAX SYSTEM TRAININGS</h2>
                    <div className="services-details-thumb">
                        <img src="/assets/img/services/services_details01.jpg" alt="" />
                    </div>
